...
interface IVector extends ICollection, IIndexAccess, IConstIndexAccess
{
     ...
     * @param  Traversable $items The collection whose elements should be added
    ...
    /**
     * Splice the Vector in place. This function provides the functional
     * equivalent of array_splice(), but for Vectors.
     * @param int $offset
     * @param int $length
     */
